...
module Orn
  ...
  # invocation goes through the SbxCli adapter; this module holds the policy
  # around those calls (ordering, cleanup, error wrapping) plus the
  # Docker-free foundations (port reservation, `.ports` persistence).
  module Sandbox
